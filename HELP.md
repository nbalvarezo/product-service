...
* The original package name 'com.meiggsmarket.product-service' is invalid and this project uses 'com.meiggsmarket.productservice' instead.
...
* [Spring Data MongoDB](https://docs.spring.io/spring-boot/docs/3.2.9/reference/htmlsingle/index.html#data.nosql.mongodb)
